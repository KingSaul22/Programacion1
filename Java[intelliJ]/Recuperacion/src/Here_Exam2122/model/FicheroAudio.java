...
public class FicheroAudio extends Fichero implements Reproducibles {
    private byte[] contenido;
    private int duracion;

    public FicheroAudio(String nombre, byte[] contenido, int duracion) throws ValorNoValidoException {
        super(nombre);
